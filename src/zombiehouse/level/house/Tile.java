...
public class Tile
{
  ...
  public void setNeighbors(Tile[][] house)
  {
    ...
    //if(xCor+1 < house.length && yCor+1 < house[0].length && house[xCor+1][yCor+1] instanceof Floor) neighbors.add(house[xCor+1][yCor+1]);
    //if(xCor+1 < house.length && yCor-1 >= 0 && house[xCor+1][yCor-1] instanceof Floor)              neighbors.add(house[xCor+1][yCor-1]);
    //if(xCor-1 >= 0 && yCor+1 < house[0].length && house[xCor-1][yCor+1] instanceof Floor)           neighbors.add(house[xCor-1][yCor+1]);
    //if(xCor-1 >= 0 && yCor-1 >= 0 && house[xCor-1][yCor-1] instanceof Floor)                        neighbors.add(house[xCor-1][yCor-1]);
  }
